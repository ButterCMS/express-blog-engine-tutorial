# express-blog-engine-tutorial
How to Add a Blog to an Express App Using the ButterCMS Blog Engine

## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Add a Blog to an Express App Using the ButterCMS Blog Engine](https://buttercms.com/blog/express-blog-tutorial/), and will not be actively maintained.
